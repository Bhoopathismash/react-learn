...
const UseMemoComponent = () => {
    ...
    return (
        <>
            ...
            <button type='button' onClick={() => setCount(count + 1) } > Change Memo Count</button>
            <button type='button' onClick={() => setArr([...arr,  Math.round(count * Math.random())]) } > Change Memo Array</button>
        </>
    );
}
